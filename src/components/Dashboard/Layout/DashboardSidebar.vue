...
<template>
    ...
    <div class="flex flex-col w-full gap-10 mt-[50px]">
      ...
      <section>
        ...
        <div class="flex flex-col gap-[14px]">
          <RouterLink :to="{ name: 'dashboard' }" class="group dashboard-link" :class="{ 'is-active': props.activeMenu === 'dashboard' }">
            <img src="@/assets/svg/ic-notification-status.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Overview
          </RouterLink>
          <RouterLink :to="{ name: 'dashboard-product-index' }" class="group dashboard-link" :class="{ 'is-active': props.activeMenu === 'product' }">
            <img src="@/assets/svg/ic-box.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Products
          </RouterLink>
          <a href="@/pages/dashboard/transactions/index-no-data.html" class="group dashboard-link">
            <img src="@/assets/svg/ic-cart.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Transactions
          </a>
          <a href="#" class="group dashboard-link">
            <img src="@/assets/svg/ic-people.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Customers
          </a>
          <a href="#" class="group dashboard-link md:hidden">
            <img src="@/assets/svg/ic-bell.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Notifications
            <span
          ...
          <a href="#" class="group dashboard-link md:hidden">
            <img src="@/assets/svg/ic-message.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Messages
            <span
      ...
      <section>
        ...
        <div class="flex flex-col gap-[14px]">
          <a href="#" class="group dashboard-link">
            <img src="@/assets/svg/ic-globe.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Merchants
          </a>
          <a href="#" class="group dashboard-link">
            <img src="@/assets/svg/ic-data.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            User Flow
          </a>
          <a href="#" class="group dashboard-link">
            <img src="@/assets/svg/ic-document.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Invoice
          </a>
          <a href="#" class="group dashboard-link">
            <img src="@/assets/svg/ic-gear.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Settings
          </a>
          <a href="#" class="group dashboard-link">
            <img src="@/assets/svg/ic-logout.svg"
              class="transition-all group-hover:filter-white group-[.is-active]:filter-white" alt="">
            Logout
          </a>
        </div>
  ...
  <div id="backdropDrawer" class="fixed z-40 hidden w-screen h-screen bg-gray-900 bg-opacity-50"></div>
</template>